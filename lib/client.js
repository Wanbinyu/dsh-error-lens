...
//#endregion
//#region \0dsh-css:G:\dsh-compat-0911\dsh-error-lens\src\client\ErrorLens.module.css.mjs
const css = ".yWvnDW_dock{box-sizing:border-box;width:calc(100% - var(--dsh-composer-side-clearance) - var(--dsh-composer-side-clearance) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset) - var(--dsh-composer-dock-inset));margin:0 auto}.yWvnDW_panel{box-sizing:border-box;width:100%;max-width:calc(var(--dsh-composer-card-max-width) - 4 * var(--dsh-composer-dock-inset));border:1px solid var(--dsw-alias-state-warning-primary);background:var(--dsw-specific-tip);border-radius:8px;margin:0 auto;overflow:hidden}.yWvnDW_panel[data-category=authentication],.yWvnDW_panel[data-category=forbidden],.yWvnDW_panel[data-category=server]{border-color:var(--dsw-alias-state-error-primary,#cf222e)}.yWvnDW_summary{align-items:center;gap:8px;min-height:36px;padding:3px 4px 3px 10px;display:flex}.yWvnDW_glyph{color:var(--dsw-alias-state-warning-primary);flex:none;display:inline-flex}.yWvnDW_panel[data-category=authentication] .yWvnDW_glyph,.yWvnDW_panel[data-category=forbidden] .yWvnDW_glyph,.yWvnDW_panel[data-category=server] .yWvnDW_glyph{color:var(--dsw-alias-state-error-primary,#cf222e)}.yWvnDW_label,.yWvnDW_category,.yWvnDW_code{white-space:nowrap;flex:none;font-size:12px;line-height:20px}.yWvnDW_label{color:var(--dsw-alias-label-primary);font-weight:600}.yWvnDW_category{color:var(--dsw-alias-label-secondary)}.yWvnDW_route{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:20px;overflow:hidden}.yWvnDW_code{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover);border-radius:4px;padding:0 6px;font-family:ui-monospace,SFMono-Regular,Consolas,monospace}.yWvnDW_actions{flex:none;gap:2px;display:inline-flex}.yWvnDW_iconButton{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;place-items:center;padding:0;display:inline-grid}.yWvnDW_iconButton:hover,.yWvnDW_iconButton:focus-visible{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover);outline:none}.yWvnDW_details{border-top:1px solid var(--dsw-alias-border-l1);padding:0 12px 10px}.yWvnDW_message{max-height:128px;color:var(--dsw-alias-label-primary);white-space:pre-wrap;overflow-wrap:anywhere;margin:10px 0;font-family:ui-monospace,SFMono-Regular,Consolas,monospace;font-size:12px;line-height:18px;overflow:auto}.yWvnDW_meta{grid-template-columns:repeat(2,minmax(0,1fr));gap:4px 16px;margin:0;display:grid}.yWvnDW_meta>div{grid-template-columns:minmax(72px,auto) minmax(0,1fr);gap:8px;min-width:0;display:grid}.yWvnDW_meta dt,.yWvnDW_meta dd,.yWvnDW_hint,.yWvnDW_privacy{margin:0;font-size:12px;line-height:18px}.yWvnDW_meta dt,.yWvnDW_privacy{color:var(--dsw-alias-label-tertiary)}.yWvnDW_meta dd{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.yWvnDW_history{margin-top:10px}.yWvnDW_history h3{color:var(--dsw-alias-label-secondary);margin:0 0 4px;font-size:12px;font-weight:600;line-height:18px}.yWvnDW_history ul{gap:2px;margin:0;padding:0;list-style:none;display:grid}.yWvnDW_history li{min-width:0;color:var(--dsw-alias-label-tertiary);grid-template-columns:auto minmax(0,1fr) auto;align-items:center;gap:8px;font-size:12px;line-height:18px;display:grid}.yWvnDW_history li>span:nth-child(2){text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.yWvnDW_history code{color:var(--dsw-alias-label-secondary)}.yWvnDW_hint{color:var(--dsw-alias-label-secondary);margin-top:10px}.yWvnDW_privacy{margin-top:6px}@media (width<=620px){.yWvnDW_summary{gap:4px;padding-left:8px}.yWvnDW_label,.yWvnDW_route{display:none}.yWvnDW_category{text-overflow:ellipsis;flex:1;overflow:hidden}.yWvnDW_meta{grid-template-columns:1fr}}";
...
var ErrorLens_module_css_default = {
	"actions": "yWvnDW_actions",
	"category": "yWvnDW_category",
	"code": "yWvnDW_code",
	"details": "yWvnDW_details",
	"dock": "yWvnDW_dock",
	"glyph": "yWvnDW_glyph",
	"hint": "yWvnDW_hint",
	"history": "yWvnDW_history",
	"iconButton": "yWvnDW_iconButton",
	"label": "yWvnDW_label",
	"message": "yWvnDW_message",
	"meta": "yWvnDW_meta",
	"panel": "yWvnDW_panel",
	"privacy": "yWvnDW_privacy",
	"route": "yWvnDW_route",
	"summary": "yWvnDW_summary"
};
...
function ErrorLens({ diagnostics, t }) {
	...
	const [dismissedRecordKey, setDismissedRecordKey] = (0, react.useState)(null);
	const record = diagnostics?.latest;
	const recordKey = record === void 0 ? null : `${diagnostics?.totalFailures ?? 0}:${record.turn}:${record.time}`;
	(0, react.useEffect)(() => {
		setCopied(false);
	}, [diagnostics?.totalFailures]);
	if (diagnostics === void 0 || diagnostics === null || !diagnostics.active || record === void 0 || recordKey === dismissedRecordKey) return null;
...
const en = {
	...
	"dismiss": "Hide diagnostics panel",
